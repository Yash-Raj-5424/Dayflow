...
Revision ID: 7e88e8fe13de
Revises: 
Create Date: 2026-08-22 10:06:38.528461
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('EMPLOYEE', 'ADMIN', name='user_role'), nullable=False),
